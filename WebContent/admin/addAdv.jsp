        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="content">
                        <form id="formadd" action="<%=request.getContextPath() %>/admin/adv/add" enctype="multipart/form-data" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tên quảng cáo</label>
                                        <input type="text" name="name" class="form-control border-input" placeholder="Tên quảng cáo" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
